/// Integration test for doctor approval migration.
///
/// Usage:
///   flutter test test/integration/doctor_approval_migration_test.dart --dart-define=DRY_RUN=true
///   flutter test test/integration/doctor_approval_migration_test.dart --dart-define=DRY_RUN=false
library;
...
void main() {
  ...
  testWidgets('Run doctor approval migration', (tester) async {
